...
public class ToFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final EditText inputData = (EditText) v.findViewById(R.id.inputTo);

        Button button = (Button) v.findViewById(R.id.btnTo);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mapView = (MapView) v.findViewById(R.id.mapViewTo);
        if (mapView != null) {
    ...
    public static void addPoint(double lat, double lng, String address) {
        ...
        InputActivity.latTo = lat;
        InputActivity.lngTo = lng;
    }
    ...
    private class GetObject extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (listItems.size() != 0){
                ...
                setInitialData();
                recyclerView = (RecyclerView) getActivity().findViewById(R.id.listDataTo);
                recyclerView.setTag("ToFragment");
